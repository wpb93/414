...
function Line(start_x, start_y, end_x, end_y, drawSpeed) {
    ...
    this.draw = function () {
        ...
        if (myself.drawPoint[drawDir] == myself.endPoint[drawDir]) return;
    ...
    this.finished = function () {
        return myself.drawPoint.x == myself.endPoint.x && myself.drawPoint.y == myself.endPoint.y;
    }
}
...
function Game(myCanvas, height, width, ballNumber, ballSpeed, ballRadius, lineSpeed, lineWidth, fps) {
    ...
    function drawNewLine(e) {
        ...
        myself.lines.push(new Line(clickPos.x, clickPos.y, endPoint.x, endPoint.y, myself.lineSpeed));
